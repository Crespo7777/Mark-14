...
const Dashboard = () => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-background gap-4">
        ...
        <p className="text-muted-foreground animate-pulse font-medium">Sincronizando Mark-14...</p>
      </div>
    );
  }
  ...
  if (isError || !dashboardData) {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-background gap-4">
            <p className="text-destructive">Erro de conexão.</p>
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Header Fixo com Identidade Visual Mark-14 */}
        ...
        <div className="container max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
           <div className="flex items-center gap-3">
               ...
               <div className="w-9 h-9 bg-primary/10 rounded-lg flex items-center justify-center border border-primary/20 shadow-[0_0_10px_rgba(var(--primary),0.2)]">
                  <img src="/meu-icone.png" alt="Logo" className="w-5 h-5 object-contain opacity-90" />
               </div>
               
               {/* Nome com gradiente */}
               <h1 className="text-2xl font-bold tracking-tight bg-gradient-to-r from-primary via-primary/80 to-primary/50 bg-clip-text text-transparent">
                   Mark-14
               </h1>
           </div>
      ...
      <main className="container max-w-7xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="space-y-1">
               ...
               <p className="text-muted-foreground">O ponto de partida para as suas campanhas.</p>
            </div>
