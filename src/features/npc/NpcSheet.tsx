...
import { 
    X, Save, Loader2, ImagePlus, Camera, Settings2, Move, Heart
} from "lucide-react";
...
import { Progress } from "@/components/ui/progress"; // <--- IMPORT CRUCIAL ADICIONADO
...
// --- CABEÇALHO "STAT BLOCK" DO MONSTRO ---
    ...
    return (
        <Card className="border-none shadow-none bg-background/50 rounded-none border-b mb-2 pb-2">
            <div className="flex flex-col md:flex-row gap-4 p-4 items-start">
                ...
                {/* Info Principal e Stats Rápidos */}
      ...
      <AlertDialog open={isCloseAlertOpen} onOpenChange={setIsCloseAlertOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>Alterações serão perdidas.</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
